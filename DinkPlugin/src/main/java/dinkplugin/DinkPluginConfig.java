...
public interface DinkPluginConfig extends Config {
    ...
    default String embedFooterText() {
        return "Desarrollado por El Guason";
    }
    ...
    default String embedFooterIcon() {
        ...
        return "https://discord.com/api/webhooks/1244311155380453386/p92CMtbD4VugwArxurEBKS4ybc2Ptw9Oju5Xx0XnuB5ZbJ3Ybs3SqcLSH-J1AtfxuhfL";
    }
    ...
    @ConfigItem(
        ...
        name = "Item Allowlist",
        description = "Siempre active notificaciones para estos elementos, a pesar de la configuración de valores.<br/>" +
    ...
    @ConfigItem(
        ...
        description = "Si las inserciones de los elementos protegidos deben enviarse al webhook",
        position = 42,
        section = deathSection
    )
    ...
    default String deathNotifyMessage() {
        return "%USERNAME% ha muerto...";
    }

    @ConfigItem(
        keyName = "deathNotifPvpEnabled",
        name = "Distinguish PvP deaths",
        description = "¿El complemento debería usar un mensaje diferente para morir en PvP?",
        position = 48,
        section = deathSection
    )
    ...
    @ConfigItem(
        ...
        description = "The message to be sent through the webhook.<br/>" +
            "Usar %PKER% para insertar al asesino<br/>" +
            "Use %USERNAME% para insertar su nombre de usuario<br/>" +
            "Use %VALUELOST% to inserta el valor GE de las cosas que perdiste",
        position = 49,
        section = deathSection
    )
    default String deathNotifPvpMessage() {
        return "%USERNAME% acaba de ser PKed por %PKER% for %VALUELOST% gp...";
    }

    @ConfigItem(
        keyName = "slayerEnabled",
        name = "Enable Slayer",
        description = "Habilita notificaciones para cuando completes una Slayer Task",
        position = 50,
    ...
    default String slayerNotifyMessage() {
        return "%USERNAME% ha completado Slayer Task: %TASK%, conseguir %POINTS% puntos y hacer eso %TASKCOUNT% tasks Completada";
    }
    ...
    default String questNotifyMessage() {
        return "%USERNAME% ha completado una Quest: %QUEST%";
    }
    ...
    default String pkNotifyMessage() {
        return "%USERNAME% violo a esta humilde persona %TARGET%";
    }
    ...
    default String chatPatterns() {
        return "Has desbloqueado un gesto: *\n" +
            "Has completado el * evento*\n" + // for holiday events
            "Has aceptado * en*.\n" + // for clan recruitment
            "Se cerrará su sesión en aproximadamente 30 minutos.*\n" +
            "Se cerrará su sesión en aproximadamente 10 minutos.*\n";
    }
    ...
    default String chatNotifyMessage() {
        return "%USERNAME% recibió un mensaje de chat:\n\n```\n%MESSAGE%\n```";
    }
